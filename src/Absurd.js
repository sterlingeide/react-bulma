...
<nav className="navbar" role="navigation" aria-label="main navigation">
  ...
  {/* <!-- Hero del producto --> */}
  <section id="colored-dna-back" className="hero is-white is-fullheight">
        ...
        <div className="columns  is-vcentered reverse-columns">
          ...
          is-5-fullhd " data-aos="fade-down">
            ...
            <div className="buttons">
              <button className="button is-yellow">Esablished technical teams</button>
          ...
          is-4-fullhd is-offset-1-fullhd">
            <figure className="image is-square">
              <img src="../../public/images/people-solving-a-puzzle.jpeg"/>
            </figure>
          </div>
